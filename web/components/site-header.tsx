    ...
    <header className="sticky top-0 z-40 border-b border-border/80 bg-background/90 backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-8">
          <Link href="/" className="flex items-center gap-2.5 group">
            <Image
              ...
              priority
            />
            <span className="font-semibold text-base tracking-tight text-foreground">OpenWrapper</span>
          </Link>
        ...
        <div className="flex items-center gap-3">
          <Button variant="ghost" size="sm" className="text-sm font-medium text-muted-foreground hover:text-foreground" asChild>
            <Link href="/sign-in">Sign in</Link>
          </Button>
          <Button size="sm" className="rounded-md font-semibold text-xs px-3.5 h-9 bg-primary text-primary-foreground shadow-2xs hover:bg-primary/90 transition-all" asChild>
            <Link href="/sign-up">
