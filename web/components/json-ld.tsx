    ...
    "@graph": [
      {
        ...
        "description": "Unified, provider-neutral payment gateway abstraction layer for Paymob, Fawry, Stripe, and MENA payment rails.",
        "address": {
          "@type": "PostalAddress",
        ...
        "sameAs": [
          "https://github.com/MoustafaAt1a/openwrapper",
        ],
      },
      {
        ...
        "description": "Enterprise-grade unified payment API and stateless routing engine supporting Paymob, Fawry, Stripe, cards, mobile wallets, and retail kiosk codes.",
