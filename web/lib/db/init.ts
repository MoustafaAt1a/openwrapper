...
export async function ensureDatabaseSchema() {
  ...
  initPromise = (async () => {
    try {
      ...
      // In build-time without live DB connection, log and allow build to proceed
      console.warn("Database schema auto-init skipped or failed:", (error as Error).message)
    }
  })()
  return initPromise
}
