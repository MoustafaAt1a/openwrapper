...
├── Makefile           # 🛠️ GNU Make task runner (make start, make test-all, make check)
...
- **🧪 Interactive Sandbox Test Data Assistant**:
  - Embedded one-click cheat sheet above checkout form.
  - Instant 1-click autofill for Paymob 3DS cards, Meeza debit, Stripe test cards, and Egyptian wallet carriers with live visual feedback.
- **⚡ Simulated Webhook Settlement Engine**:
  - Live `[⚡ Simulate Webhook Settlement]` action in the result card.
