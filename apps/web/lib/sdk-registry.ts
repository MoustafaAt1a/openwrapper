...
export const SDK_DOCS: Record<"typescript" | "php" | "dotnet", SdkDoc> = {
  typescript: {
    ...
    ecosystem: "Node.js 18+ • Browser • Deno",
    ...
    badgeText: "Official • TypeScript & Node",
    installCommand: "pnpm add @openwrapper/sdk",
    installAlternatives: [
      { label: "npm", command: "npm install @openwrapper/sdk" },
      { label: "Yarn", command: "yarn add @openwrapper/sdk" },
    ],
    requirements: [
      "Node.js 18.0.0 or higher (or Deno 1.35+, or modern browser)",
