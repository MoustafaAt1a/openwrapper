...
function TableHead({ className, ...props }: React.ComponentProps<"th">) {
  return (
    <th
      ...
      className={cn(
        "h-10 px-3.5 text-left align-middle font-medium whitespace-nowrap text-foreground border-b border-border/80 [&:has([role=checkbox])]:pr-0",
        className,
      )}
      {...props}
    />
...
function TableCell({ className, ...props }: React.ComponentProps<"td">) {
  return (
    <td
      ...
      className={cn(
        "px-3.5 py-2.5 align-middle whitespace-nowrap border-b border-border/40 [&:has([role=checkbox])]:pr-0",
        className,
      )}
      {...props}
    />
