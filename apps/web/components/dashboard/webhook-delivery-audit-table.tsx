...
export function WebhookDeliveryAuditTable({ initialWebhooks }: Props) {
              ...
              <TableCell colSpan={4} className="h-36 text-center">
                <div className="flex flex-col items-center justify-center gap-1.5">
                  ...
                  <p className="text-[11px] text-muted-foreground max-w-sm">
                    Configure your Paymob, Fawry, or Stripe destination URLs in the Providers panel
                    to stream verified webhooks.
                  </p>
                </div>
              </TableCell>
            </TableRow>
