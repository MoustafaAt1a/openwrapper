      ...
      <div className="relative isolate flex-1 overflow-hidden py-16 sm:py-24">
        ...
        <div className="relative z-10 mx-auto max-w-3xl px-4 sm:px-6">
          ...
          <article className="prose-sm flex flex-col gap-8 text-muted-foreground leading-relaxed">
            <section>
              <h2 className="text-lg font-medium text-foreground mb-3">Acceptance of terms</h2>
            ...
            <section>
              <h2 className="text-lg font-medium text-foreground mb-3">Monetary amounts</h2>
              <p className="text-sm leading-relaxed">
                All monetary values in the OpenWrapper API are expressed as integer minor units
                (e.g., cents for USD, piasters for EGP). You must never send floating-point numbers
                for currency amounts. OpenWrapper will reject requests containing non-integer amount
                values.
              </p>
            </section>

            <section>
              <h2 className="text-lg font-medium text-foreground mb-3">Provider credentials</h2>
              <p className="text-sm leading-relaxed">
                You are responsible for the security of your payment provider credentials. When
                using Stateless Zero-Knowledge Mode, credentials are passed via TLS headers and are
                never stored by OpenWrapper. When using ambient environment configuration,
                credentials are held in memory only and are not persisted to disk.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-sm leading-relaxed">
                OpenWrapper is provided &ldquo;as is&rdquo; without warranty of any kind.
                OpenWrapper is not liable for any payment processing failures, declined
                transactions, or losses arising from the use of upstream payment providers.
                Transaction disputes and chargebacks are handled directly between you and the
                relevant payment processor.
              </p>
            </section>

            <section>
              <h2 className="text-lg font-medium text-foreground mb-3">Open source license</h2>
              <p className="text-sm leading-relaxed">
            ...
            <section>
              <h2 className="text-lg font-medium text-foreground mb-3">Changes to terms</h2>
              <p className="text-sm leading-relaxed">
                We may update these terms from time to time. Material changes will be communicated
                via the developer dashboard or email. Continued use of the platform after changes
