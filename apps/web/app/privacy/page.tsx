        ...
        <article className="prose-sm flex flex-col gap-8 text-muted-foreground leading-relaxed">
          <section>
            ...
            <p className="text-sm leading-relaxed">
              ...
              (timestamps, endpoint paths, response codes), and aggregated transaction telemetry for
              your dashboard.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed">
              ...
              are transmitted exclusively via encrypted TLS headers and are never persisted to any
              database, log file, or telemetry system. Cardholder data (PANs, CVVs, expiration
              dates) never enters the OpenWrapper perimeter — all card handling is delegated
              directly to the upstream payment processor.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed">
              ...
              Stripe). Each provider has its own privacy policy that governs the cardholder data
              they process.
            </p>
          </section>
