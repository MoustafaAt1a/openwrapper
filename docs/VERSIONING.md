...
Example output:
```
🔍 OpenWrapper Monorepo Version Status (Canonical: 0.2.0)
=====================================================================================
...
-------------------------------------------------------------------------------------
 ...
 .NET SDK                  | NuGet      | sdk/dotnet/src/OpenWrapper/OpenWrapper.csproj | 0.2.0    | MATCH
 OpenAPI Spec (YAML)       | OpenAPI    | docs/openapi/openapi.yaml      | 0.2.0    | MATCH
 OpenAPI Spec (JSON)       | OpenAPI    | docs/openapi/openapi.json      | 0.2.0    | MATCH
 SDK Contract Vectors      | Vectors    | tests/vectors/sdk-contract.json | 0.2.0    | MATCH
 GraphQL Health Resolver   | GraphQL    | apps/web/lib/graphql/resolvers.ts | 0.2.0    | MATCH
 GraphQL Health Test       | Test       | apps/web/test/graphql.test.ts  | 0.2.0    | MATCH
=====================================================================================

✅ All 11 package manifests and contract targets are in sync at v0.2.0.
```
